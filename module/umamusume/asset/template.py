...
UI_CULTIVATE_CONTINUE = Template("CULTIVATE_CONTINUE", UMAMUSUME_UI_TEMPLATE_PATH)
...
UI_RACE_RESULT_1ST = Template("RACE_RESULT_1ST", UMAMUSUME_UI_TEMPLATE_PATH)
...
UI_TOURNAMENT_MENU = Template("TOURNAMENT_MENU", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TOURNAMENT_JJC_MENU = Template("TOURNAMENT_JJC_MENU", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TOURNAMENT_JJC_ENEMY_SELECT = Template("TOURNAMENT_JJC_ENEMY_SELECT", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TOURNAMENT_JJC_ENEMY_DETAIL = Template("TOURNAMENT_JJC_ENEMY_DETAIL", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TOURNAMENT_JJC_ENEMY_SKIP = Template("TOURNAMENT_JJC_ENEMY_SKIP", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TOURNAMENT_JJC_RESULT_1 = Template("TOURNAMENT_JJC_RESULT_1", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TOURNAMENT_JJC_RESULT_2 = Template("TOURNAMENT_JJC_RESULT_2", UMAMUSUME_UI_TEMPLATE_PATH)
UI_TOURNAMENT_JJC_BONUS = Template("TOURNAMENT_JJC_BONUS", UMAMUSUME_UI_TEMPLATE_PATH)

UI_DAILY_RACE_SELECT_1 = Template("DAILY_RACE_SELECT_1", UMAMUSUME_UI_TEMPLATE_PATH)
UI_DAILY_RACE_SELECT_2 = Template("DAILY_RACE_SELECT_2", UMAMUSUME_UI_TEMPLATE_PATH)
UI_DAILY_RACE_MOONLIGHT = Template("DAILY_RACE_MOONLIGHT", UMAMUSUME_UI_TEMPLATE_PATH)
UI_UMAMUSUME_SELECT = Template("UMAMUSUME_SELECT", UMAMUSUME_UI_TEMPLATE_PATH)
UI_NO_PARENT_UMAMUSUME = Template("NO_PARENT_UMAMUSUME", UMAMUSUME_UI_TEMPLATE_PATH)
