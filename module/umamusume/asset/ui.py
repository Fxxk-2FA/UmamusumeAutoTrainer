...
CULTIVATE_CONTINUE = UI("CULTIVATE_CONTINUE", [template.UI_CULTIVATE_CONTINUE], [])
...
TOURNAMENT_MENU = UI("TOURNAMENT_MENU", [template.UI_TOURNAMENT_MENU], [])
TOURNAMENT_JJC_MENU = UI("TOURNAMENT_JJC_MENU", [template.UI_TOURNAMENT_JJC_MENU], [])
TOURNAMENT_JJC_ENEMY_SELECT = UI("TOURNAMENT_JJC_ENEMY_SELECT", [template.UI_TOURNAMENT_JJC_ENEMY_SELECT], [])
TOURNAMENT_JJC_ENEMY_DETAIL = UI("TOURNAMENT_JJC_ENEMY_DETAIL", [template.UI_TOURNAMENT_JJC_ENEMY_DETAIL], [])
TOURNAMENT_JJC_ENEMY_SKIP = UI("TOURNAMENT_JJC_ENEMY_SKIP", [template.UI_TOURNAMENT_JJC_ENEMY_SKIP], [])
TOURNAMENT_JJC_RESULT_1 = UI("TOURNAMENT_JJC_RESULT_1", [template.UI_TOURNAMENT_JJC_RESULT_1, template.UI_TOURNAMENT_JJC_RESULT_2], [])
TOURNAMENT_JJC_RESULT_2 = UI("TOURNAMENT_JJC_RESULT_2", [template.UI_TOURNAMENT_JJC_RESULT_2], [])
TOURNAMENT_JJC_BONUS = UI("TOURNAMENT_JJC_BONUS", [template.UI_TOURNAMENT_JJC_BONUS], [])

DAILY_RACE_SELECT = UI("DAILY_RACE_SELECT", [template.UI_DAILY_RACE_SELECT_1, template.UI_DAILY_RACE_SELECT_2], [])
DAILY_RACE_MOONLIGHT_SELECT = UI("DAILY_RACE_MOONLIGHT_SELECT", [template.UI_DAILY_RACE_SELECT_1, template.UI_DAILY_RACE_MOONLIGHT], [])
UMAMUSUME_SELECT = UI("UMAMUSUME_SELECT", [template.UI_UMAMUSUME_SELECT], [])

NO_PARENT_UMAMUSUME = UI("NO_PARENT_UMAMUSUME", [template.UI_NO_PARENT_UMAMUSUME], [])

scan_ui_list = [MAIN_MENU, CULTIVATE_CONTINUE, NO_PARENT_UMAMUSUME,
                ...
                TOURNAMENT_MENU, TOURNAMENT_JJC_MENU, TOURNAMENT_JJC_ENEMY_SELECT, TOURNAMENT_JJC_ENEMY_DETAIL, TOURNAMENT_JJC_ENEMY_SKIP,
                TOURNAMENT_JJC_RESULT_1, TOURNAMENT_JJC_RESULT_2, TOURNAMENT_JJC_BONUS,
                DAILY_RACE_SELECT, DAILY_RACE_MOONLIGHT_SELECT, UMAMUSUME_SELECT]
